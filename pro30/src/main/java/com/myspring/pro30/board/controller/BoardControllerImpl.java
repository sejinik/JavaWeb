...
public class BoardControllerImpl implements BoardController {
	...
	public ModelAndView listArticles(HttpServletRequest request, HttpServletResponse rsHttpServletResponse)
			throws Exception {
...
public class BoardControllerImpl  implements BoardController{
	...
	public ResponseEntity addNewArticle(MultipartHttpServletRequest multipartRequest, 
		...
		List<String> fileList = uploads(multipartRequest);
	...
	public ResponseEntity modArticle(MultipartHttpServletRequest multipartRequest, HttpServletResponse response)
		...
		try {
			...
			message = "<script>";
			message += " alert('오류가 발생했습니다. 다시 수정해주세여');";
			message += " location.href='"+multipartRequest.getContextPath()+"/board/viewArticle.do?articleNO="+articleNO+"'";
			message +="</script>";
			resEnt = new ResponseEntity(message,responseHeader,HttpStatus.CREATED);
		}
	...
	// 다중 이미지 업로드
	private List<String> uploads(MultipartHttpServletRequest multipartRequest) throws Exception {
