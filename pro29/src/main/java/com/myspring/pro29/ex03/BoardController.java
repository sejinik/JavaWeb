...
public class BoardController {
	...
	public ResponseEntity<List<ArticleVO>> listArticles(){
		...
		return new ResponseEntity<List<ArticleVO>>(articlesList,HttpStatus.OK);
	}
	...
	public ResponseEntity<String> addArticle(@RequestBody ArticleVO article) {
	...
	public ResponseEntity<String> modArticle(@PathVariable("articleNO") Integer articleNO,@RequestBody ArticleVO article){
		ResponseEntity<String> resEntity = null;
		try {
